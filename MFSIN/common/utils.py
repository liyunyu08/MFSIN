...
def parse_args(arg_mode):
    ...
    parser.add_argument('-milestones', nargs='+', type=str, default=[60,70], help='milestones for MultiStepLR')
    ...
    parser.add_argument('-num_token', type=int, default=4, help='number of testing episodes after training')
    ...
    parser.add_argument('-no_wandb', action='store_true', help='not plotting learning curve on wandb', default=arg_mode == 'train')  # train: enable logging / test: disable logging
